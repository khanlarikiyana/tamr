...
//    @Transactional
//    public TbStudent insertStudentWithJpa(StudentCreateRequestDto studentCreateRequestDto) {
//        TbStudent student= new TbStudent();
//        student.setId(studentCreateRequestDto.getId());
//        student.setFirstName(studentCreateRequestDto.getFirstname());
//        student.setLastName(studentCreateRequestDto.getLastname());
//        student.setStuAge(studentCreateRequestDto.getStuAge());
//        return studentCommandRepositoryWithJpa.insert(student);
//    }
